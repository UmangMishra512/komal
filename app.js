...
const DATA = {
  ...
  /* 20 reasons — front label + back detail */
  reasons: [
  ...
  /* Gallery items — add real image src paths to replace placeholders */
  gallery: [
  ...
  /* Quiz questions & options — all options lead to "Correct!" */
  quiz: [
    {
      q: "Who gets angry first?",
      options: ["You", "Definitely You", "100% You"]
    },
    {
      q: "Who takes longer to get ready?",
      options: ["Obviously You", "You (no contest)", "You, but make it glamorous"]
    },
    {
      q: "Who apologizes last?",
      options: ["You, eventually", "Still You", "You (but gracefully)"]
    },
    {
      q: "Who is the funnier one?",
      options: ["Objectively You", "You, always", "Is this even a question? You."]
    },
    {
      q: "Who has better taste in everything?",
      options: ["Clearly You", "You (obviously)", "You, and everyone knows it"]
    },
    {
      q: "Who deserves the best birthday ever?",
      options: ["YOU ❤️", "YOU!! ❤️❤️", "YOU (obviously, duh) ❤️❤️❤️"]
    }
  ]
};
